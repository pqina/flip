...
/*
 * @pqina/flip v1.8.2 - A Beautifully Animated Flip Clock
 ...
 */
        ...
        var rooter = function (state) {
            ...
            return {
                appendTo: function appendTo(element) {
                    var location =
                        arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'last';
        ...
        var toTransition = function toTransition(string) {
            return string
                .match(/[a-z]+(?:\(.*?\))?\s?(?:origin\(.*?\))?\s?(?:[a-z]+\(.*?\))?[ .a-z-0-9]*/g)
        ...
        var easeInBack = function easeInBack(t) {
            var magnitude =
                arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1.70158;
        ...
        var easeOutElastic = function easeOutElastic(t) {
            ...
            return (
                Math.pow(2, -10 * scaledTime) * Math.sin(((scaledTime - s) * (2 * Math.PI)) / p) + 1
            );
        };
        ...
        var animate = function animate(cb, complete) {
            ...
            var ease =
                arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : easeLinear;
        ...
        var createTranslator = function createTranslator(type) {
            for (
                var _len = arguments.length, options = Array(_len > 1 ? _len - 1 : 0), _key = 1;
                _key < _len;
                _key++
            ) {
        ...
        var arrive = function arrive(update) {
            ...
            return function (cb) {
                ...
                update(cb, from, to, function (state, cancel) {
                    ...
                    if (
                        (state.origin < state.destination && state.position >= state.destination) ||
                        (state.origin >= state.destination && state.position <= state.destination)
                    ) {
                        cancel();
                        state.velocity = 0;
        ...
        var createDurationTransitioner = function createDurationTransitioner(transition) {
            var origin =
                arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '50% 50% 0';
            var duration = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 500;
        ...
        var cloneDefinition = function cloneDefinition(definition) {
            ...
            for (var key in definition) {
                ...
                if (key === 'children') {
                    clone[key] =
                        definition[key] === null ? null : definition[key].map(cloneDefinition);
                    continue;
                }
        ...
        var composeAsync = function composeAsync(instance) {
            for (
                var _len = arguments.length, funcs = Array(_len > 1 ? _len - 1 : 0), _key = 1;
                _key < _len;
                _key++
            ) {
        ...
        var toParameters = function toParameters(string) {
            return (string.match(/('.+?')|(".+?")|(\[.+?])|([.:\-\d\sa-zA-Z]+%?)/g) || [])
                .map(trim)
                .filter(function (str) {
                    return str.length;
                })
 ...
 */
                    ...
                    },
                    {
                        ...
                        value: function _init() {
                            ...
                            if (this._viewDefinition.root !== this._element) {
                                Array.from(this._viewDefinition.root.children).forEach(function (
                                    node
                                ) {
  ...
  */
        ...
        var tween = function (duration) {
            var ease =
                arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'ease-linear';
        ...
        var fade = function fade(element, p, direction) {
            var ease =
                arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : easeInOutQuad;
